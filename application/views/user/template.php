...
<body class="hold-transition skin-blue layout-top-nav navbar-fixed">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <div class="container">
                ...
                <strong>Copyright &copy; <?= date('Y') ?> <a href="https://smaadzkiadt.sch.id/">SMA ADZKIA ISLAMIC SCHOOL</a>.</strong> All rights
                reserved.
            </div>
            <!-- /.container -->
        </footer>
